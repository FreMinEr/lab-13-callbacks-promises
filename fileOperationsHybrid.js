...
/**
 * Hybrid file manager: callback if last argument is a function, otherwise Promise.
 * Extra error handling: path traversal check, empty names, missing files.
 * Lab 13, student: Parfenok Ivan Nikolaevich, group 477, variant 17
 */
